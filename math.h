...
#endif
#endif
#if (__HAVE_FLOAT16 && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF16 (__builtin_nansf16(""))
#endif
#if (__HAVE_FLOAT32 && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF32 (__builtin_nansf32(""))
#endif
#if (__HAVE_FLOAT64 && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF64 (__builtin_nansf64(""))
#endif
#if (__HAVE_FLOAT128 && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF128 (__builtin_nansf128(""))
#endif
#if (__HAVE_FLOAT32X && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF32X (__builtin_nansf32x(""))
#endif
#if (__HAVE_FLOAT64X && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
#define SNANF64X (__builtin_nansf64x(""))
#endif
#if (__HAVE_FLOAT128X && __GLIBC_USE(IEC_60559_TYPES_EXT) && (defined __USE_GNU || !__GLIBC_USE(ISOC2X)))
...
#define __MATH_TG(TG_ARG, FUNC, ARGS)            \
    _Generic((TG_ARG),                           \
             float                               \
             : FUNC##f ARGS,                     \
               __MATH_TG_F32(FUNC, ARGS) default \
             : FUNC ARGS,                        \
               long double                       \
             : FUNC##l ARGS,                     \
...
#endif
#define __MATH_TG(TG_ARG, FUNC, ARGS)                                                                                              \
    __builtin_choose_expr(__builtin_types_compatible_p(__typeof(TG_ARG), float),                                                   \
                          FUNC##f ARGS,                                                                                            \
                          __builtin_choose_expr(__builtin_types_compatible_p(__typeof(TG_ARG), double),                            \
                                                FUNC ARGS,                                                                         \
                                                __builtin_choose_expr(__builtin_types_compatible_p(__typeof(TG_ARG), long double), \
                                                                      FUNC##l ARGS,                                                \
                                                                      FUNC##f128 ARGS)))
#endif
#else
...
#if ((__GNUC_PREREQ(4, 4) && !defined __SUPPORT_SNAN__) || __glibc_clang_prereq(2, 8)) && (!defined __OPTIMIZE_SIZE__ || defined __cplusplus)
...
#if (__GNUC_PREREQ(4, 4) && !defined __SUPPORT_SNAN__) || __glibc_clang_prereq(2, 8)
...
#elif (__GNUC_PREREQ(4, 4) && !defined __SUPPORT_SNAN__) || __glibc_clang_prereq(3, 7)
